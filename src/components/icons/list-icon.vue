<template>
    <svg version="1.1" id="check-icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 427.1 427.1" width="15" height="15" style="enable-background:new 0 0 427.1 427.1;" xml:space="preserve">
<g>
	<g>
